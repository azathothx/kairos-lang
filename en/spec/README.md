...
(`design/40-examples/`) and by the reference implementation (`impl/`, 396 tests). All remaining
...
- Design records — 45 ADRs, domain model, expressiveness studies: [`design/INDEX.md`](../../design/INDEX.md) (Japanese)
