...
**Status: Release candidate (RC5, declared 2026-07-08; addenda through no. 17, 2026-08-28).**
...
(`design/40-examples/`) and by the reference implementation (`impl/`, 626 tests). All remaining
