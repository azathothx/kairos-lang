...
**Status: Release candidate (RC5, declared 2026-07-08; addenda through no. 16, 2026-08-28).**
...
(`design/40-examples/`) and by the reference implementation (`impl/`, 623 tests). All remaining
