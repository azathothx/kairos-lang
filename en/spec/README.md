...
**Status: Release candidate (RC5, declared 2026-07-08; addenda through no. 15, 2026-08-26).**
...
(`design/40-examples/`) and by the reference implementation (`impl/`, 618 tests). All remaining
...
- Design records — 53 ADRs, domain model, expressiveness studies: [`design/INDEX.md`](../../design/INDEX.md) (Japanese)
