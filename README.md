...
**Release candidate (RC5, declared 2026-07-08; addenda through no. 16, 2026-08-28).** Semantics, the operator family, grammar (EBNF), and lexis are
...
is validated against 20 well-known schedule families and by a reference implementation (623 tests),
